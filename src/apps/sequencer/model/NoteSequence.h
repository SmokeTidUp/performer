...
public:
    ...
    public:
        ...
        static bool stepChanged() const { return this->stepChanged; } // to determine whether the step was changed | hubert
        static void setStepChanged(bool changed) { this->stepChanged = changed; } // set that step was changed | hubert
